...
Inspired by an [interesting article](https://staltz.com/open-analytics.html) from [@stalz](https://github.com/staltz), and from the awesome work done by the [micro-analytics](https://github.com/micro-analytics/micro-analytics-cli), I decided to start working on a ga alternative.
